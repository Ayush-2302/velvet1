...
function Body() {
  return (
    <>
      ...
      <div className="cards sm:flex-wrap md:flex-wrap  lg:grow flex ">
      ...
      <div className=" cards3 flex sm:flex-wrap md:flex-wrap mb-5">
          ...
          <table>
            ...
            <tbody className=" text-sm">
              <tr>
                ...
                <td className=" text-sm pl-16">Patty Furniture <br />patty@gmail.com</td>
              ...
              <tr>
                ...
                <td className=" text-sm pl-16">Allie Grate <br />allie@spuko.com</td>
              ...
              <tr>
                ...
                <td className=" text-sm pl-16">Peg Legge <br />pegy@spuko.com</td>
              ...
              <tr>
                <td className=" pl-8">01</td>
                <td className=" text-sm pl-16">Maureen Biologist <br />maureen@gmail.com</td>
              ...
              <tr>
                <td className=" pl-8">01</td>
                <td className=" text-sm pl-16">olive Yew <br />patty@gmail.com</td>
