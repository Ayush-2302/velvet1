  ...
  return (
    <>
      ...
      <div className=" lg:flex  md:grid   ">
        <div className="card  lg:w-1/2 card1">
        ...
        <div className="card card2 lg:w-full h-full">
        ...
        <div className="card lg:w-1/2  card3 lg:mt-auto md:mt-14">
          <div className="top flex  justify-between">
      ...
      <div className=" lg:flex md:grid ">
        <div className="card lg:w-1/2 card4">
          <div className="top flex justify-between">
            <h1 className=" text-2xl font-bold">Scales Value </h1>
            <button className="w-fit bg-blue-200 rounded-2xl p-1">
              View All
        ...
        <div className="card card5 lg:w-full grow overflow-x-auto h-full  ">
          <div className="top flex justify-between">
      ...
      {/* second row third card */}
        ...
        <div className="card lg:w-1/2 card6 lg:mt-10 md:mt-14">
          <div className="top flex justify-between">
        ...
        <div className="cards lg:flex md:grid">

        <div className="card card7 lg:w-1/2 sm:w-11/12 ">
          <div className="top flex justify-between">
      ...
      <div className="card card8 grow lg:w-full  overflow-x-auto">
